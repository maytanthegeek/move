...
func (s *Slider) CreateRenderer() fyne.WidgetRenderer {
	...
	active := canvas.NewHorizontalGradient(color.RGBA{218, 80, 25, 255}, color.RGBA{184, 160, 34, 255})
	thumb := &canvas.Circle{
		FillColor:   color.RGBA{184, 160, 34, 255},
		StrokeWidth: 10,
		StrokeColor: color.RGBA{28, 30, 34, 255},
	}

	objects := []fyne.CanvasObject{track, active, thumb}

	slide := &sliderRenderer{track, active, thumb, s, objects}
...
func (r *sliderRenderer) SetObjects(objects []fyne.CanvasObject) {
	r.objects = objects
}
